...
ball_vel = [1 , 1]
paddle1_pos = ((HEIGHT / 2) - (0.5 * PAD_HEIGHT))
paddle2_pos = ((HEIGHT / 2) - (0.5 * PAD_HEIGHT))
paddle1_vel = 0
paddle2_vel = 0
score1 = 0
score2 = 0
...
def draw(canvas):
    ...
    canvas.draw_polygon([[WIDTH, paddle2_pos], [WIDTH, paddle2_pos + PAD_HEIGHT],
                   [(WIDTH - PAD_WIDTH), paddle2_pos + PAD_HEIGHT],[(WIDTH - PAD_WIDTH),
                   paddle2_pos]],1, "White")
    ...
    # draw scores
    canvas.draw_text(str(score1), [240 , 60], 35, "White")
    canvas.draw_text(str(score2), [340 , 60], 35, "White")
